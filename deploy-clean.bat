...
echo Forcing correct credentials for harleygurl1977
echo ========================================
echo.

REM Force clear ALL git credentials from Windows Credential Manager
echo Clearing Windows credential cache...
...
REM Configure git to always ask for credentials (bypass cache)
...
echo When prompted, use these credentials:
